...
struct Node {
    int key;
    int degree;
    boolean mark; // Mark for cascading cuts
    Node *parent, *child, *left, *right;

    Node(int k) : key(k), degree(0), mark(false), parent(null), child(null) {
...
public:
    ...
    FibonacciHeap() : minNode(null), nodeCount(0) {}
    ...
    void consolidate() {
        ...
        std::vector<Node*> degreeTable(maxDegree, null);
    ...
    void printRootList() {
        ...
        do {
            std::System.out.print( temp.key << "(D" << temp.degree << ") ";
            temp = temp.right;
        } while (temp != minNode);
...
public static void main(String[] args) {
    FibonacciHeap fh;
    std::System.out.print( "--- Insert & Get Minimum Demo ---" );
    fh.insert(23);
    fh.insert(7);
    fh.insert(21);
    fh.insert(3);
    fh.insert(17);
    fh.printRootList();
    std::System.out.print( "Minimum key: " << fh.minNode.key );

    std::System.out.print( "\n--- Delete Minimum Demo ---" );
    std::System.out.print( "Extracted min: " << fh.deleteMin() );
    fh.printRootList();
    std::System.out.print( "New minimum key: " << fh.minNode.key );

    std::System.out.print( "\n--- Union Demo ---" );
    FibonacciHeap fh2;
    fh2.insert(11);
    fh2.insert(2); // This will be the new min
    std::System.out.print( "Heap 1: "; fh.printRootList();
    std::System.out.print( "Heap 2: "; fh2.printRootList();
    fh.unionHeaps(fh2);
    std::System.out.print( "Combined Heap: "; fh.printRootList();
    std::System.out.print( "Minimum of combined heap: " << fh.minNode.key );

    std::System.out.print( "\n--- Decrease Key & Delete Demo ---" );
    ...
    std::System.out.print( "Initial demo heap: "; demoHeap.printRootList();
    
    // Decrease Key
    std::System.out.print( "Decreasing key of node 30 to 5." );
    demoHeap.decreaseKey(nodes[2], 5); // nodes[2] is the node with key 30
    std::System.out.print( "Heap after decrease key: "; demoHeap.printRootList();
    std::System.out.print( "New minimum: " << demoHeap.minNode.key );
    
    // Delete Node
    std::System.out.print( "Deleting node with original key 20." );
    demoHeap.deleteNode(nodes[1]); // nodes[1] is the node with key 20
    std::System.out.print( "Heap after deleting node: "; demoHeap.printRootList();
    std::System.out.print( "New minimum: " << demoHeap.minNode.key );
