...
public static void main(String[] args) {
    ...
    std::System.out.print( "--- Max Heap Demo ---" );
    ...
    // --- Get Max Operation ---
    std::System.out.print( "\nMaximum element is: " << maxHeap.getMax() );
    
    // --- Extract Max Operations ---
    std::System.out.print( "Extracted max: " << maxHeap.extractMax() );
    maxHeap.printHeap();
    
    std::System.out.print( "Extracted max: " << maxHeap.extractMax() );
    maxHeap.printHeap();

    std::System.out.print( "\nFinal maximum element is: " << maxHeap.getMax() );
    std::System.out.print( "Final heap size: " << maxHeap.getSize() );
