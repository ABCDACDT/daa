...
public:
    ...
    void remove(int data) {
        ...
        if (nodeToDelete->color == BLACK) {
            nodeToDelete->color = (child != nullptr) ? child->color : BLACK;
...
int main() {
    ...
    tree.insert(7);
    std::cout << "Inserted 7: "; tree.inorder();
    tree.insert(6);
    std::cout << "Inserted 6: "; tree.inorder();
    tree.insert(5); // Causes rotation
    std::cout << "Inserted 5: "; tree.inorder();
    tree.insert(4);
    std::cout << "Inserted 4: "; tree.inorder();
    tree.insert(3); // Causes recoloring
    std::cout << "Inserted 3: "; tree.inorder();
    tree.insert(2); // Causes rotation
    std::cout << "Inserted 2: "; tree.inorder();
    tree.insert(1); // Causes recoloring
    std::cout << "Inserted 1: "; tree.inorder();
    
    std::cout << "\nMinimum Key in Tree: " << tree.getMinimumKey() << std::endl;
    std::cout << "Root of Tree: " << tree.getRootValue() << std::endl;

    // Deletion Demo
    std::cout << "\n--- Deletion Demo ---" << std::endl;
    std::cout << "Initial Tree: "; tree.inorder();
    
    tree.remove(1); // Simple leaf deletion
    std::cout << "Deleted 1: "; tree.inorder();
    tree.remove(3); // Deletion causing fixup
    std::cout << "Deleted 3: "; tree.inorder();
    tree.remove(5);
    std::cout << "Deleted 5: "; tree.inorder();
    tree.remove(6); // Deleting root's child
    std::cout << "Deleted 6: "; tree.inorder();
    tree.remove(7); // Deleting the root
    std::cout << "Deleted 7: "; tree.inorder();
    tree.remove(4);
    std::cout << "Deleted 4: "; tree.inorder();
    tree.remove(2);
    std::cout << "Deleted 2: "; tree.inorder();
